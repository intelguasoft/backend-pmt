                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-3 col-xs-12">
                        <div class="form-group @error('oficial_id') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="oficial_id" id="oficial_id" value="{{ old('oficial_id') }}"
                                placeholder="9434389" aria-describedby="help-oficial_id">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="form-group @error('date_birthday') has-error @enderror">
                            ...
                            {{-- <input type="text" class="form-control" name="date_birthday" id="date_birthday" value="{{ old('date_birthday') }}" placeholder="Nombre" aria-describedby="help-date_birthday"> --}}
                            <div class="input-group date">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control pull-right" data-date-format="dd-mm-yyyy" name="date_birthday" id="datepicker" value="{{ old('date_birthday') }}" placeholder="12-12-1998" aria-describedby="help-date_birthday">
                            </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group @error('first_name') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="first_name" id="first_name" value="{{ old('first_name') }}"
                                placeholder="Juan Raul" aria-describedby="help-first_name">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group @error('last_name') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="last_name" id="last_name" value="{{ old('last_name') }}"
                                placeholder="Cuc Choc" aria-describedby="help-last_name">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group @error('gender') has-error @enderror">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="gender" id="gender" placeholder="Género">
                                ...
                                <option value="Male" {{ (\Illuminate\Support\Facades\Input::old("gender") == 'Male' ? "selected":"") }}>Masculino</option>
                                <option value="Female" {{ (\Illuminate\Support\Facades\Input::old("gender") == 'Female' ? "selected":"") }}>Femenino</option>
                                <option value="Undefined" {{ (\Illuminate\Support\Facades\Input::old("gender") == 'Undefined' ? "selected":"") }}>Indefinido</option>
                            </select>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group @error('nit') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="nit" id="nit" value="{{ old('nit') }}"
                                placeholder="4329043-k" aria-describedby="help-nit">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group @error('dpi') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="dpi" id="dpi" value="{{ old('dpi') }}"
                                placeholder="2248 3030 32303" aria-describedby="help-dpi">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group @error('email') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="email" id="email" value="{{ old('email') }}"
                                placeholder="mi.correo@tu-dominio.com" aria-describedby="help-email">
