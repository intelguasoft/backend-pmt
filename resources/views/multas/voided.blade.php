...
<h1>Multas - <small>Anulación</small></h1>
@stop

@section('content')
<!-- general form elements -->
<div class="box box-info">
    <form role="form" action="{{ route('multas.anular', ['multa' => $multa]) }}" method="POST" autocomplete="off">
        <div class="box-header with-border">
            <h4>Información importante! <small>La anulación de una multa es un proceso irreversible, tome la debidas precausiones para el proceso.</small></h4>
        </div>
        @csrf()
        @method('PUT')
        <!-- /.box-header -->
